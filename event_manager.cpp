...
namespace ButtonEvents {
  ...
  Storage::Binding EventManager::add_button(Button* button) { return _buttons.add(button); }

  EventGroupHandle_t EventManager::event_group(const size_t index) { return _event_groups[index]; }
